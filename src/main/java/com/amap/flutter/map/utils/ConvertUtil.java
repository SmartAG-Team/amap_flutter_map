            ...
            case "fromAsset":
                if (data.size() == 2) {
                    return BitmapDescriptorFactory.fromAsset(
                            "flutter_assets/some.png"); //FlutterMain.getLookupKeyForAsset(toString(data.get(1)))
                } else {
                    return BitmapDescriptorFactory.fromAsset(
                            "flutter_assets/some.png");//FlutterMain.getLookupKeyForAsset(toString(data.get(1)), toString(data.get(2))));
                }
            case "fromAssetImage":
                if (data.size() == 3) {
                    return BitmapDescriptorFactory.fromAsset(
